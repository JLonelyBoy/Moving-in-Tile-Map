...
public class GenTileMap : MonoBehaviour {
	...
	public void initWall(){
		...
		locale = new Vector3 (size_x, rightWall.transform.localScale.y * wallHeigh, wallThickness);
		pos = new Vector3 (size_z / 2f, locale.y / 2f, -(size_z + 0.01f)) ;
		rightWall.transform.localScale = locale * tileSize;
		rightWall.transform.position = pos * tileSize;
		...
		locale = new Vector3 (wallThickness, leftWall.transform.localScale.y * wallHeigh, size_z);
		pos = new Vector3 (size_z + 0.01f, locale.y / 2f, -size_z / 2f);
		leftWall.transform.localScale = new Vector3 (wallThickness, leftWall.transform.localScale.y * wallHeigh, size_z) * tileSize;
		leftWall.transform.position = pos * tileSize;
